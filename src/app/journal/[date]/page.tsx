...
export default async function JournalPage({ params }: { params: Promise<{ date: string }> }) {
  ...
  const [{ data: profile }, { data: entry }, { data: markers }] = await Promise.all([
